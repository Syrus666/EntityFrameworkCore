...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class QueryFilterFuncletizationContext : DbContext
    {
        ...
        public void ConfigureFilter(EntityTypeBuilder<LocalMethodFilter> builder)
        {
            builder.HasQueryFilter(e => e.IsEnabled == Field);
        }

        public static void ConfigureFilterParams(
        ...
        public static void IncorrectFilter(EntityTypeBuilder<ParameterFilter> builder, int tenant)
        {
